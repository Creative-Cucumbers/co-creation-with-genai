...
専門分野: UXデザイン
略歴:
  理工学系学部卒業後、オランダの工科大学工業デザイン工学科へ正規留学。
  複数の産学連携プロジェクトを通じて、ユーザー・ビジネス・技術的制約を踏まえたプロダクトデザインに従事。
  2023年より外資系IT企業に勤務し、現在はプリセールス組織のUXデザイナーとして活動。
  お客様やチームとデザイン思考を実践しながら、自社製品がユーザーとビジネスにもたらす価値を、実際の現場で検証している。
```
